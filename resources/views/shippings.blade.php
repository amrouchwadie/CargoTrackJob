...
<main class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
      <div class="breadcrumb-title pe-3">eCargo</div>
      <div class="ps-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-0 p-0">
            <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
            </li>
            <li class="breadcrumb-item active" aria-current="page">Cargo List</li>
          </ol>
        </nav>
      </div>
      <div class="ms-auto">
        <div class="btn-group">
          ...
          <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-end">	
            <a class="dropdown-item" onclick="printpage()" href="javascript:void();" >
              Print
            </a>
            <button class="dropdown-item" onclick="download()">Excel</button>
        ...
        <div class="card-header py-3">
          <div class="row align-items-center m-0">
            ...
            <div class="col-md-4 col-6">
              <form class="mr-3 position-relative" action="{{ url('recherche') }}" type="get">
                <div class="form-group mb-0">
                 <table >
                   <tbody>
                 <tr>
                   <td > <input type="search" class="form-control" id="exampleInputSearch" name="query" placeholder="Search" aria-controls="user-list-table">
                   </td>
